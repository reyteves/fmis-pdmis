...
<script>
    $(document).ready(function() {
        ...
        fetch('/get-regions-dropdown')
            ...
            .then(data => {
                // Find all td elements with the field-key 'region'
                let regionTds = $('td[field-key="region"]');
                // Loop through each td and set its text content to the name of the region
                regionTds.each(function() {
                    let regionCode = $(this).text();
