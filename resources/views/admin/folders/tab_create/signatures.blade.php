{{-- Signatures Checklist --}}
    <div class="form-row">
        ...
        <div class="form-group">
            <div class="form-check">
                {!! Form::checkbox('evaluated_by', 'Evaluated by: Provincial Officer', false, ['id' => 'evaluated_by', 'class' => 'form-check-input']) !!}
    ...
    <div class="form-row">
        <div class="form-group">
            <div class="form-check">
                {!! Form::checkbox('confirmed_by', 'Confirmed by: IPS/IPO Heads/IP Leader/Elder', false, ['id' => 'confirmed_by', 'class' => 'form-check-input']) !!}
        ...
        <div class="form-group">
            <div class="form-check">
                {!! Form::checkbox('validated_by', 'Validated by: Regional Staff', false, ['id' => 'validated_by', 'class' => 'form-check-input']) !!}
    ...
    <div class="form-row">
        <div class="form-group">
            <div class="form-check">
                {!! Form::checkbox('endorsed_by', 'Endorsed by: Regional Director', false, ['id' => 'endorsed_by', 'class' => 'form-check-input']) !!}
        ...
        <div class="form-group">
            <div class="form-check">
                {!! Form::checkbox('recommended_by', 'Recommending Approval: Executive Director', false, ['id' => 'recommended_by', 'class' => 'form-check-input']) !!}
    ...
    <div class="form-row">
        <div class="form-group">
            <div class="form-check">
                {!! Form::checkbox('approved_by', 'Approved by: Chairperson', false, ['id' => 'approved_by', 'class' => 'form-check-input']) !!}
