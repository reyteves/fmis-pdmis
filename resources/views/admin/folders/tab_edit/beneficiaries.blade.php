    ...
    <tbody>
        <tr class="text-center">
            ...
            <td style="width: 25.6868%;">
                {!! Form::number('ip_group_total', old('ip_group_total',$folder->beneficiaries->ip_group_total), ['class' => 'form-control']) !!}
            </td>
          
            <td style="width: 27.6099%;">
                {!! Form::number('ip_group_male', old('ip_group_male', $folder->beneficiaries->ip_group_male), ['class' => 'form-control']) !!}
            </td>
            
            <td style="width: 30.4602%;">
                {!! Form::number('ip_group_female', old('ip_group_female', $folder->beneficiaries->ip_group_female), ['class' => 'form-control']) !!}
            </td>
        ...
        <tr class="text-center">
            ...
            <td style="width: 25.6868%;">
                {!! Form::number('pwd_total', old('pwd_total', $folder->beneficiaries->pwd_total), ['class' => 'form-control']) !!}
            </td>
            <td style="width: 27.6099%;">
                {!! Form::number('pwd_male', old('pwd_male', $folder->beneficiaries->pwd_male), ['class' => 'form-control']) !!}
            </td>
            <td style="width: 30.4602%;">
                {!! Form::number('pwd_female', old('pwd_female', $folder->beneficiaries->pwd_female), ['class' => 'form-control']) !!}
            </td>
        </tr>
        ...
        <tr class="text-center">
            ...
            <td style="width: 25.6868%;">
                {!! Form::number('children_total', old('children_total', $folder->beneficiaries->children_total), ['class' => 'form-control']) !!}
            </td>
            
            <td style="width: 27.6099%;">
                {!! Form::number('children_male', old('children_male', $folder->beneficiaries->children_male), ['class' => 'form-control']) !!}
            </td>
            
            <td style="width: 30.4602%;">
                {!! Form::number('children_female', old('children_female', $folder->beneficiaries->children_female), ['class' => 'form-control']) !!}
            </td>
        </tr>
        ...
        <tr class="text-center">
            ...
            <td style="width: 25.6868%;">
                {!! Form::number('youth_total', old('youth_total', $folder->beneficiaries->youth_total), ['class' => 'form-control']) !!}
            </td>
            
            <td style="width: 27.6099%;">
                {!! Form::number('youth_male', old('youth_male', $folder->beneficiaries->youth_male), ['class' => 'form-control']) !!}
            </td>
            
            <td style="width: 30.4602%;">
                {!! Form::number('youth_female', old('youth_female', $folder->beneficiaries->youth_female), ['class' => 'form-control']) !!}
            </td>
        </tr>
        ...
        <tr class="text-center">
            ...
            <td style="width: 25.6868%;">
                {!! Form::number('adult_total', old('adult_total', $folder->beneficiaries->adult_total), ['class' => 'form-control']) !!}
            </td>
            
            <td style="width: 27.6099%;">
                {!! Form::number('adult_male', old('adult_male', $folder->beneficiaries->adult_male), ['class' => 'form-control']) !!}
            </td>
            
            <td style="width: 30.4602%;">
                {!! Form::number('adult_female', old('adult_female', $folder->beneficiaries->adult_female), ['class' => 'form-control']) !!}
            </td>
        ...
        <tr class="text-center">
            ...
            <td style="width: 25.6868%;">
                {!! Form::number('older_total', old('older_total', $folder->beneficiaries->older_total), ['class' => 'form-control']) !!}
            </td>
            
            <td style="width: 27.6099%;">
                {!! Form::number('older_male', old('older_male', $folder->beneficiaries->older_male), ['class' => 'form-control']) !!}
            </td>
            
            <td style="width: 30.4602%;">
                {!! Form::number('older_female', old('older_female', $folder->beneficiaries->older_female), ['class' => 'form-control']) !!}
            </td>
        </tr>
