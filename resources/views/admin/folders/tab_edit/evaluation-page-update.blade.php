    ...
    <div classs="evaluate_page_input">
        <table>
            ...
            <div class="input-container">
                ...
                {!! Form::textarea(
                    'location',
                    old('location', $folder->evaluation->location),
                    [
                        'class' => 'form-control',
                        'rows' => 1,
            ...
            <div class="input-container">
                ...
                {!! Form::textarea(
                    'cost_and_source',
                    old('cost_and_source', $folder->evaluation->cost_and_source),
                    [
                        'class' => 'form-control',
                        'rows' => 1,
            ...
            <div class="input-container">
                <p
                    style='margin-top:0cm;margin-right:0cm;margin-bottom:8.65pt;margin-left:-.75pt;font-size:11.0pt;font-family:"Calibri",sans-serif;color:black;'>
                    <strong>Period of implementation&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; :</strong>
                </p>
                {!! Form::textarea(
            ...
            <div class="input-container">
                ...
                {!! Form::textarea(
                    'no_of_beneficiaries',
                    old('no_of_beneficiaries', $folder->evaluation->no_of_beneficiaries),
                    [
                        'class' => 'form-control',
                        'rows' => 1,
            ...
            <div class="input-container">
                ...
                {!! Form::textarea(
                    'synopsis',
                    old('synopsis', $folder->evaluation->synopsis),
                    [
                        'class' => 'form-control',
                        'rows' => 1,
