...
<div class="form-row">
    <div class="form-group">
        <div class="form-check">
            {!! Form::checkbox('prepared_by_checkbox', 'Prepared by: CSC Staff', old('prepared_by_checkbox', $folder->signature->prepared_by_checkbox), ['id' => 'prepared_by_checkbox', 'class' => 'form-check-input']) !!}
    ...
    <div class="form-group">
        <div class="form-check">
            {!! Form::checkbox('evaluated_by_checkbox', 'Evaluated by: Provincial Officer', old('evaluated_by_checkbox', $folder->signature->evaluated_by_checkbox), ['id' => 'evaluated_by_checkbox', 'class' => 'form-check-input']) !!}
...
<div class="form-row">
    <div class="form-group">
        <div class="form-check">
            {!! Form::checkbox('confirmed_by_checkbox', 'Confirmed by: IPS/IPO Heads/IP Leader/Elder', old('confirmed_by_checkbox', $folder->signature->confirmed_by_checkbox), ['id' => 'confirmed_by_checkbox', 'class' => 'form-check-input']) !!}
    ...
    <div class="form-group">
        <div class="form-check">
            {!! Form::checkbox('validated_by_checkbox', 'Validated by: Regional Staff', old('validated_by_checkbox', $folder->signature->validated_by_checkbox), ['id' => 'validated_by_checkbox', 'class' => 'form-check-input']) !!}
...
<div class="form-row">
    <div class="form-group">
        <div class="form-check">
            {!! Form::checkbox('endorsed_by_checkbox', 'Endorsed by: Regional Director', old('endorsed_by_checkbox', $folder->signature->endorsed_by_checkbox), ['id' => 'endorsed_by_checkbox', 'class' => 'form-check-input']) !!}
    ...
    <div class="form-group">
        <div class="form-check">
            {!! Form::checkbox('recommended_by_checkbox', 'Recommending Approval: Executive Director', old('recommended_by_checkbox', $folder->signature->recommended_by_checkbox), ['id' => 'recommended_by_checkbox', 'class' => 'form-check-input']) !!}
...
<div class="form-row">
    <div class="form-group">
        <div class="form-check">
            {!! Form::checkbox('approved_by_checkbox', 'Approved by: Chairperson', old('approved_by_checkbox', $folder->signature->approved_by_checkbox), ['id' => 'approved_by_checkbox', 'class' => 'form-check-input']) !!}
