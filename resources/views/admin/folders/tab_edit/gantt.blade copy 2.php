...
<body>
    <div class="panel" style="margin-bottom: 25px">
        ...
        <!-- start date for task_1 -->
        <label for="task_1_start_date" class="col-form-label text-md-end">Task 1 Start Date</label>
        {{ Form::date('task_1_start_date', \Carbon\Carbon::now(), ['class' => 'form-control', 'id' => 'task_1_start_date']) }}
        <!-- end date for task_1 -->
        <label for="task_1_end_date" class="col-form-label text-md-end">Task 1 End Date</label>
        ...
        <!-- start date for task_2 -->
        <label for="task_2_start_date" class="col-form-label text-md-end">Task 2 Start Date</label>
        {{ Form::date('task_2_start_date', \Carbon\Carbon::now(), ['class' => 'form-control', 'id' => 'task_2_start_date']) }}
        <!-- end date for task_2 -->
        <label for="task_2_end_date" class="col-form-label text-md-end">Task 2 End Date</label>
        ...
        <!-- start date for task_3 -->
        <label for="task_3_start_date" class="col-form-label text-md-end">Task 3 Start Date</label>
        {{ Form::date('task_3_start_date', \Carbon\Carbon::now(), ['class' => 'form-control', 'id' => 'task_3_start_date']) }}
        <!-- end date for task_3 -->
        <label for="task_3_end_date" class="col-form-label text-md-end">Task 3 End Date</label>
        ...
        <!-- start date for task_4 -->
        <label for="task_4_start_date" class="col-form-label text-md-end">Task 4 Start Date</label>
        {{ Form::date('task_4_start_date', \Carbon\Carbon::now(), ['class' => 'form-control', 'id' => 'task_4_start_date']) }}
        <!-- end date for task_4 -->
        <label for="task_4_end_date" class="col-form-label text-md-end">Task 4 End Date</label>
        ...
        <!-- start date for task_5 -->
        <label for="task_5_start_date" class="col-form-label text-md-end">Task 5 Start Date</label>
        {{ Form::date('task_5_start_date', \Carbon\Carbon::now(), ['class' => 'form-control', 'id' => 'task_5_start_date']) }}
        <!-- end date for task_5 -->
        <label for="task_5_end_date" class="col-form-label text-md-end">Task 5 End Date</label>
        ...
        <!-- start date for task_6 -->
        <label for="task_6_start_date" class="col-form-label text-md-end">Task 6 Start Date</label>
        {{ Form::date('task_6_start_date', \Carbon\Carbon::now(), ['class' => 'form-control', 'id' => 'task_6_start_date']) }}
        <!-- end date for task_6 -->
        <label for="task_6_end_date" class="col-form-label text-md-end">Task 6 End Date</label>
        ...
        <!-- start date for task_7 -->
        <label for="task_7_start_date" class="col-form-label text-md-end">Task 7 Start Date</label>
        {{ Form::date('task_7_start_date', \Carbon\Carbon::now(), ['class' => 'form-control', 'id' => 'task_7_start_date']) }}
        <!-- end date for task_7 -->
        <label for="task_7_end_date" class="col-form-label text-md-end">Task 7 End Date</label>
