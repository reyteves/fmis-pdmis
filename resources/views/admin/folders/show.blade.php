...
@section('content')
    ...
    <p>
        ...
        @if (Auth::getUser()->role_id == 2 && $userFilesCount > 5)
            ...
            <a href="{{ url('admin/files/create?folder_id=' . $folder->id) }}" class="btn btn-success disabled">Attach New
                File to this Project</a>
        ...
        @else
            ...
            <a href="{{ url('admin/files/create?folder_id=' . $folder->id) }}" class="btn btn-success">Attach New File to this
                Project</a>
        @endif
    </p>
