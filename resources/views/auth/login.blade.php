...
@section('content')
    <div class="row h-100 w-60 card" style="justify-content:center;display:flex; margin-left: 10px; margin-right: 10px;"
        id="login-box">
        <div class="col-md-5">

            <div class="panel panel-default" style="padding-top:10px;padding-bottom:20px;">
                <div class="login-logo" style="margin-top: 30px">
                    <a href="/">
                        <img src="{{ asset('images/app/NCIP_logo150x150.png') }}"
                            alt="{{ config('app.name', 'NCIP-HRMIS') }} Logo" class="img-circle" style="height:65px;">
                        <b>NCIP</b>PDMIS
                    </a>

                </div>

                <p class="login-box-msg"><span style="font-family: Calibri, sans-serif; font-size: 15px;"><strong>Project
                            Development Management Information System</strong></span></p>
                {{-- <div class="panel">{{ ucfirst(config('app.name')) }} @lang('quickadmin.qa_login')</div> --}}

                <div class="panel-body card-body login-card-body"
                    style="padding-top: 10px; padding-left:100px; padding-right:100px;">
                    <p class="login-box-msg"><span style="font-family: Calibri, sans-serif; font-size: 14px;">Sign in to
                            start your session</span></p>
                    @if (count($errors) > 0)
